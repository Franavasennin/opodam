    ...
    <div className="min-h-screen bg-slate-50">
      <header className="bg-white border-b border-slate-200 px-4 py-3">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-lg font-bold text-slate-900">Estadísticas</h1>
        </div>
      </header>
      <div className="p-4 max-w-2xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="text-center">
            <p className="text-3xl font-bold text-marca-600">{progreso.racha.dias}</p>
            <p className="text-xs text-slate-500 mt-1">Días de racha</p>
          </Card>
          <Card className="text-center">
            <p className="text-3xl font-bold text-marca-600">{horas}h {mins}m</p>
            <p className="text-xs text-slate-500 mt-1">Tiempo total</p>
          </Card>
        </div>
        {conDatos.length === 0
          ? <p className="text-slate-400 text-sm text-center py-8">Estudia algún tema para ver estadísticas.</p>
          : (
            <Card>
              <h2 className="text-slate-900 font-bold text-sm mb-3">Rendimiento por tema</h2>
